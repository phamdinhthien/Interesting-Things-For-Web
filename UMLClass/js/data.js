...
var btnLoadDiagram = document.getElementById('btnLoadDiagram');
loadDiagram.addEventListener('click', async function () {
    ...
    if (problemId !== '') {
        ...
        myDiagram.div = null;
        // set spinner
        btnLoadDiagram.innerHTML = '<div class="spinner-border text-primary"></div>'
        var rq = '';
        var nodedata = '';
        var linkdata = '';
        ...
        try {
            ...
            btnLoadDiagram.innerHTML = '<button id="loadDiagram" class="btn btn-success">Load</button>';
        }
        catch (err) {
            console.log(err)
        }
